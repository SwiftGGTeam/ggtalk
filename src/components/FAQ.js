      ...
      <Container fluid className='android'>
        ...
        <Row className='desc'>
          <Col className='center' xs={12} sm={10} md={8} lg={6}>
            最近一段时间陆陆续续有听众反馈无法播放，沟通了一下，目前来看唯一的共同点是大家都在广州。
            <br /><br />
            我们使用的是腾讯云的 CDN 服务，不是很清楚具体原因，可能是 CDN 在广州那边有什么问题，不能很好的提供服务。
            <br /><br />
            如果无法播放，请尝试使用我们的<a target='_blank' rel="noopener noreferrer" href='https://talkcdn.swift.gg'>备用域名</a>。
            <br /><br />
            如果备用域名也无法访问，请直接访问我们的<a target='_blank' rel="noopener noreferrer" href='https://talkorigin.swift.gg'>源站</a>。
            <br /><br />
